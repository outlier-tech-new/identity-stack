...
echo ""
echo "2. Update Traefik to route traffic to this IDP node:"
echo "   # Run on EACH Traefik node (sec001, sec002):"
echo "   cd /srv/security-stack"
echo "   ./scripts/add-idp-backend.sh ${HOST}"
echo ""
echo "   # Or via SSH from this host:"
echo "   ssh sysadmin@sec001 'cd /srv/security-stack && ./scripts/add-idp-backend.sh ${HOST}'"
echo "   ssh sysadmin@sec002 'cd /srv/security-stack && ./scripts/add-idp-backend.sh ${HOST}'"
echo ""
echo "3. Access Keycloak admin console (from browser):"
echo "   https://idp.outliertechnology.co.uk/admin/"
echo ""
echo "4. Verify Traefik routing (from sec001):"
echo "   curl -k https://idp.outliertechnology.co.uk/"
echo ""
echo "5. Update DNS if this is a new host:"
echo "   # Already configured for idp01, idp02 in zone files"
echo ""
